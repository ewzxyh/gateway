...
<header class="sticky app-header" id="header">
    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-left">
            ...
            <!-- Start::header-element -->
            <div class="my-auto header-element header-search d-md-block d-none">
                <!-- Start::header-link -->
                ...
                <a href="javascript:void(0);" class="border-0 header-search-icon">
        ...
        <ul class="header-content-right">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    ...
                    <ul class="mb-0 list-unstyled" id="header-cart-items-scroll">
                        <li class="dropdown-item">
                            <div class="gap-3 d-flex align-items-center cart-dropdown-item">
                                <div class="lh-1">
                                    <span class="bg-gray-300 avatar avatar-md">
                                        <img src="{{ asset("/assets/images/ecommerce/png/30.png") }}" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="mb-0 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="text-end">
                                            ...
                                            <h6 class="mt-1 mb-0 fw-medium">$75<span class="text-decoration-line-through text-muted fw-normal ms-1 fs-13 d-inline-block">$99</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="gap-3 d-flex align-items-center cart-dropdown-item">
                                ...
                                <div class="flex-fill">
                                    <div class="mb-0 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="text-end">
                                            <a href="javascript:void(0);" class="header-cart-remove dropdown-item-close"><i class="ri-delete-bin-line"></i></a>
                                            <h6 class="mt-1 mb-0 fw-medium">$120<span class="text-decoration-line-through text-muted fw-normal ms-1 fs-13 d-inline-block">$149</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="dropdown-item">
                            <div class="gap-3 d-flex align-items-center cart-dropdown-item">
                                <div class="lh-1">
                                    <span class="bg-gray-300 avatar avatar-md">
                                        <img src="{{ asset("/assets/images/ecommerce/png/32.png") }}" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="mb-0 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="text-end">
                                            <a href="javascript:void(0);" class="header-cart-remove dropdown-item-close"><i class="ri-delete-bin-line"></i></a>
                                            <h6 class="mt-1 mb-0 fw-medium">$30<span class="text-decoration-line-through text-muted fw-normal ms-1 fs-13 d-inline-block">$49</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="dropdown-item">
                            <div class="gap-3 d-flex align-items-center cart-dropdown-item">
                                <div class="lh-1">
                                    <span class="bg-gray-300 avatar avatar-md">
                                        <img src="{{ asset("/assets/images/ecommerce/png/12.png") }}" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="mb-0 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="text-end">
                                            <a href="javascript:void(0);" class="header-cart-remove dropdown-item-close"><i class="ri-delete-bin-line"></i></a>
                                            <h6 class="mt-1 mb-0 fw-medium">$70<span class="text-decoration-line-through text-muted fw-normal ms-1 fs-13 d-inline-block">$129</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="dropdown-item">
                            <div class="gap-3 d-flex align-items-center cart-dropdown-item">
                                <div class="lh-1">
                                    <span class="bg-gray-300 avatar avatar-md">
                                        <img src="{{ asset("assets/images/ecommerce/png/16.png") }}" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="mb-0 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="text-end">
                                            <a href="javascript:void(0);" class="header-cart-remove dropdown-item-close"><i class="ri-delete-bin-line"></i></a>
                                            <h6 class="mt-1 mb-0 fw-medium">$200<span class="text-decoration-line-through text-muted fw-normal ms-1 fs-13 d-inline-block">$249</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="p-5 empty-item d-none">
                        <div class="text-center">
                            ...
                            <h6 class="mt-3 mb-1 fw-medium">Your Cart is Empty</h6>
            ...
            <li class="header-element notifications-dropdown d-xl-block d-none dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="messageDropdown" aria-expanded="false">
                    ...
                    <span class="rounded header-icon-pulse bg-secondary pulse pulse-secondary"></span>
                </a>
                <!-- End::header-link|dropdown-toggle -->
                <!-- Start::main-header-dropdown -->
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    ...
                    <div class="p-5 empty-item1 d-none">
                        <div class="text-center">
                            ...
                            <h6 class="mt-3 fw-medium">No New Notifications</h6>
                        </div>
                    </div>
                </div>
                <!-- End::main-header-dropdown -->
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <div class="me-xl-2 me-0">
                            <img src="{{ asset("/assets/images/faces/14.jpg") }}" alt="img" class="avatar avatar-sm avatar-rounded">
                        </div>
