                ...
                <div class="mb-4 col-xxl-3 col-md-6">
                    <div class="border-4 card card-raised card-border-color ">
                        <div class="px-4 card-body" style="min-height: 114px">
                            <div class="mb-2 d-flex justify-content-between align-items-center">
                                <div class="me-2">
                                    <div class="display-5">R$ {{ number_format((clone $transactions)->where('status', 'COMPLETED')->sum('amount'), '2',',','.') }}</div>
                                    <div class="card-text">Saidas</div>
                                </div>
                ...
                <div class="mb-4 col-xxl-3 col-md-6">
                    <div class="border-4 card card-raised card-border-color ">
                        <div class="px-4 card-body" style="min-height: 114px">
                            <div class="mb-2 d-flex justify-content-between align-items-center">
                                <div class="me-2">
                                    <div class="display-5">R$ {{ number_format((clone $transactions)->where('status', 'CHARGEBACK')->sum('cash_out_liquido'), '2',',','.') }}</div>
                                    <div class="card-text">Chargebacks</div>
                                </div>
                ...
                <div class="mb-4 col-xxl-3 col-md-6">
                    <div class="border-4 card card-raised card-border-color ">
                        <div class="px-4 card-body" style="min-height: 114px">
                            <div class="mb-2 d-flex justify-content-between align-items-center">
                                <div class="me-2">
                                    <div class="display-5">R$ {{ number_format((clone $transactions)->where('status', 'MED')->sum('cash_out_liquido'), '2',',','.') }}</div>
                                    <div class="card-text">MED</div>
                                </div>
