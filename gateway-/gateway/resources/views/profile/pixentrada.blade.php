                ...
                <div class="mb-4 col-xxl-3 col-md-6">
                    <div class="border-4 card card-raised card-border-color ">
                        <div class="px-4 card-body" style="min-height: 114px">
                            <div class="mb-2 d-flex justify-content-between align-items-center">
                                <div class="me-2">
                                    <div class="display-5">R$ {{ number_format((clone $transactions)->sum('amount'), '2',',','.') }}</div>
                                    <div class="card-text">Faturamento</div>
                                </div>
                ...
                <div class="mb-4 col-xxl-3 col-md-6">
                    <div class="border-4 card card-raised card-border-color ">
                        <div class="px-4 card-body" style="min-height: 114px">
                            <div class="mb-2 d-flex justify-content-between align-items-center">
                                <div class="me-2">
                                    <div class="display-5">R$ {{ number_format((clone $transactions)->sum('deposito_liquido'), '2',',','.') }}</div>
                                    <div class="card-text">Valor liquido</div>
                                </div>
                        ...
                        <div class="px-4 card-body" style="min-height: 114px">
                            <div class="mb-2 d-flex justify-content-between align-items-center">
                                <div class="me-2">
                                    ...
                                    @endphp
                                    <div class="display-5"> R$ {{ number_format($ticketMedio, 2, ',', '.') }}</div>
                                    <div class="card-text">Ticket médio</div>
                                </div>
                                <div class="text-white icon-circle bg-info card-color"><i class="fa-solid fa-receipt"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @break
                                                 @case('RELEASE')
                                                <span class="badge badge-sm bg-info gateway-badge-info" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Será liberado em {{ \Carbon\Carbon::parse($transaction->date)->addDays($transaction->days_availability ?? 21)->format('d/m/Y \à\s H:i:s') }}" data-bs-placement="top" >A Liberar</span>
                                                @break
                                                @default
